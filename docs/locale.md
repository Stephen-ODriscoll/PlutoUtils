...
### system_locale()
Returns a reference to a local static **std::locale** for the system locale. Define [PLUTO_LOCALE_NO_STATIC](#PLUTO_LOCALE_NO_STATIC) as 1 to avoid using local statics.

### default_locale()
Returns a reference to a local static **std::locale** for the default locale. See [PLUTO_LOCALE_DEFAULT_LOCALE](#PLUTO_LOCALE_DEFAULT_LOCALE). Define [PLUTO_LOCALE_NO_STATIC](#PLUTO_LOCALE_NO_STATIC) as 1 to avoid using local statics.
